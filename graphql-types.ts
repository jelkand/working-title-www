...
export type SiteFieldsEnum = 
  ...
  | 'siteMetadata___menuLinks___url'
  | 'port'
  | 'host'
  | 'id'
  | 'parent___id'
...
export type SiteMetaDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<{ menuLinks?: Maybe<Array<Maybe<Pick<SiteSiteMetadataMenuLinks, 'name' | 'url'>>>> }> }> };
